...
.BlendExt([0x005555, 1.0, 0x464600, 1.0, 0x464646, 1.0, 0x460046, 1.0])
.BorderExt(5, [0x00aaaa, 1.0, 0xaaaa00, 1.0, 0xaaaaaa, 1.0, 0xaa00aa, 1.0])
.Rounding(15)
.Draw();

CleanConvex([270, 100,   360, 120,   370, 180,   280, 200])
.BlendExt([0x00aaaa, 1.0, 0xaaaa00, 1.0, 0xaaaaaa, 1.0, 0xaa00aa, 1.0])
.BorderExt(5, [0x005555, 1.0, 0x464600, 1.0, 0x464646, 1.0, 0x460046, 1.0])
.Rounding(25)
.Draw();
